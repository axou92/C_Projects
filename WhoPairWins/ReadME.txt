...
Moreover, you have the possibility to add your images.
To do that, add your images into the following images folder:
	YourPath\WhoPairWins\x64\Debug\Images (For the shortcut application)
...
In this example you can see the course of the application:
	1) Open the application
	2) Set your time
	3) Read the instruction if you don't know it
	4) Press any key to lunch the application
	5) Make your pair with your justification in secret with the paper
	6) Compare who have the same pair and add the score
	7) Hold down the escape key to leave the game

---------------------------------------------------------- INFORMATION -----------------------------------------------------------

The source code is given and feel free to make improvement on it.
To do that:
	1) Download the librairy OpenCV with the version 3.4.2 
	2) Create a new C++ project solution
	3) Initialise your project for using the openCV librairy in x64
	4) Add the given code into the project and add a Images folder at the righ emplacement
	5) Run the project 

----------------------------------------------------------- IMPORTANT ------------------------------------------------------------

Make your own rules and add your images to have more fun.
